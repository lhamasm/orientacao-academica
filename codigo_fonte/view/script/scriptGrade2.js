...
// Quebrou o modal 
// $(document).ready(
// 	$(".materias-selecionadas").hover(function(){
// 		$(".materias-selecionadas button").css("color", "white");
// 	}, function(){
// 		$(".materias-selecionadas button").css("color", "transparent" );
// 	});
// });
...
function expandir_botao(id, obj){
	...
	if(botao.style.display == "block"){
		...
		var index = codigosmateriasselecionadas.indexOf(id);
		if (index > -1) {
		...
		codigosmateriasselecionadas.push(id);
	}
}
...
function confirmaMaterias(){
	// codigo php para exibir as materias na tela em quadrados 
}
